...
export class AddInstitutionComponent {
  ...
  private initForms() {
    this.institutionFormGroup = this.formBuilder.group({
      ...
      hospitalBedsNumber: [],
      hospitalCapacity: [],
      regularDoctorNumber: [0],
      busyDoctorNumber: [0],
      individualsDoctorNumber: [0],
      middleRegularPersonalNumber: [0],
      middleBusyPersonalNumber: [0],
      middleIndividualsPersonalNumber: [0],
      otherRegularPersonalNumber: [0],
      otherBusyPersonalNumber: [0],
      otherIndividualsPersonalNumber: [0],
      totalRegularPersonalNumber: [0],
      totalBusyPersonalNumber: [0],
      totalIndividualsPersonalNumber: [0],
